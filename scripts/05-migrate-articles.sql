-- ================================================================
-- HOME GARDEN MANUAL - MIGRATION SCRIPT 05/05
-- CONTENT DATA (Profiles, Roles, Articles, History)
-- ================================================================
-- Execute AFTER 04-migrate-data.sql
-- IMPORTANT: Create users in Auth BEFORE running this script!
-- URLs are already updated to NEW Supabase: lhtetfcujdzulfyekiub
-- ================================================================
...
-- The user_id values below assume specific UUIDs are generated.
-- If your UUIDs are different, update the user_id values.
-- ================================================================
...
-- ================================================================
-- SECTION 3: ARTICLES (10 articles)
-- All URLs updated to new Supabase!
-- ================================================================
...
-- ================================================================
-- END OF MIGRATION SCRIPT 05/05
-- ================================================================
-- 
-- CHECKLIST FINAL:
-- ✅ 01-schema-tables.sql - Extensões, Tipos, 25 Tabelas
-- ✅ 02-schema-functions.sql - 7 Funções
-- ✅ 03-schema-rls-indexes.sql - Índices, RLS, Triggers, Storage
-- ✅ 04-migrate-data.sql - Configurações, Templates
-- ✅ 05-migrate-articles.sql - Profiles, Roles, 10 Artigos, Histórico
--
-- IMPORTANTE:
-- 1. Crie os 3 buckets de storage manualmente no Dashboard
-- 2. Configure os secrets nas Edge Functions
-- 3. Migre as imagens do storage antigo para o novo
-- ================================================================
